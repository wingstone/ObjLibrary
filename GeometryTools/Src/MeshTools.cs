...
namespace GeometryTools
{
    ...
    {
        /// <summary>
        /// Creates an instanced copy of a mesh at specified transforms.
        /// </summary>
        /// <param name="transforms">Array of transforms to place mesh copies.</param>
        /// <param name="mesh">Base mesh to copy.</param>
        /// <returns>Combined mesh with all instances.</returns>
        public static Mesh CopyMeshToTransforms(Mesh mesh, Transform[] transforms)
        {
            ...
            if (mesh.vertices != null)
                outMesh.vertices = new Vector3[mesh.vertices.Length * transforms.Length];
            if (mesh.normals != null)
                outMesh.normals = new Vector3[mesh.normals.Length * transforms.Length];
            if (mesh.uvs0 != null)
                outMesh.uvs0 = new Vector2[mesh.uvs0.Length * transforms.Length];
            if (mesh.uvs1 != null)
                outMesh.uvs1 = new Vector2[mesh.uvs1.Length * transforms.Length];
            if (mesh.triangles != null)
                outMesh.triangles = new int[mesh.triangles.Length * transforms.Length];
            ...
            for (int i = 0; i < transforms.Length; i++)
            {
                ...
                if (mesh.vertices != null && outMesh.vertices != null)
                {
                    for (int j = 0; j < mesh.vertices.Length; j++)
                    {
                        ...
                        outMesh.vertices[vertexOffset + j] = vertex;
                    }
                }

                // Copy normals (no translation, rotation and scale only)
